      ...
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/80 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-xs font-bold tracking-[0.15em] uppercase" style={{ color: '#00A8A8' }}>Campus Transformation</span>
          ...
          {tab === 'dashboard' && (
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {[
                  { label: 'Team Members', value: stats.members, color: '#00A8A8' },
                  { label: 'Open Tasks', value: stats.tasks, color: '#3B82F6' },
                  { label: 'Total Hours Logged', value: stats.hours.toFixed(1), color: '#8B5CF6' },
                ].map(s => (
              ...
              {/* Key Documents */}
              <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
                <h2 className="font-bold text-sm mb-4" style={{ color: '#0C1F3F' }}>Key Documents</h2>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                <h2 className="font-bold text-sm mb-4" style={{ color: '#0C1F3F' }}>Recent Activity</h2>
